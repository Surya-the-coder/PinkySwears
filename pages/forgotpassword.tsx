...
const forgotpassword = () => {
	return (
		<div className=" mix-blend-normal bg-gradient-to-t from-[#FDEBF7] to-[#FFBCD1] flex min-h-screen flex-col items-center py-2">
			...
			<div className="bg-white mx-4 rounded-3xl text-center h-auto shadow-forgot-div-password-shadow">
				<h3 className=" pt-16 pb-5 text-black text-xl font-bold font-[Sarabun-Bold]">Reset Password1</h3>
				...
				<button className=" bg-[#F67A95] mt-24 mb-9 h-14 w-80 rounded-3xl text-white shadow-send-button-shadow font-[Sarabun-Regular] -tracking-tighter">Send</button>				
			</div>
